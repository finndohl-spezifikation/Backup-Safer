...
import { backupCommand, handleBackup } from './commands/backup.js';
import { listCommand, handleList } from './commands/list.js';
import { handleSelectMenu, handleButton } from './handlers/interactionHandler.js';
...
client.once('ready', async () => {
  ...
  try {
    await rest.put(Routes.applicationCommands(CLIENT_ID), {
      body: [backupCommand, listCommand],
    });
    console.log('[OK] Slash-Befehle registriert!');
  } catch (err) {
    console.error('[FEHLER] Befehle konnten nicht registriert werden:', err);
  }
});
